  ...
  return (
    ...
    <Box sx={{width:"80%",margin:"10% auto",padding:"0% 10px"}}>
        ...
        <Box sx={{marginTop:"2%",display:"flex",justifyContent:"center",alignContent:"center",alignItems:"center",gap:"15px"}}>
            ...
            <a className='socialLogo' target={"_blank"} href={details.instagramLink} style={{textDecoration:"none",color:"white",fontSize:"1.7rem"}}><i className="fa-solid fa-phone"></i></a>
