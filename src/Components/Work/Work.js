                ...
                details.projects.map((ele,index)=>{
                  return(
                      ...
                      <ListItem key={index} style={{display:"block"}}>
                            <Zoom   in={checked1}>
                              <Box className='projects' sx={{display:"grid",gap:"15px",backgroundColor:"rgba(0, 0, 0, 0.300)",padding:"0 15px",borderRadius:"5px",width:"100%",margin:"auto",height:"100%"}}>
                                ...
                                <Box className='projectDescription'sx={{height:"100%"}} >
                                    <Box sx={{display:"flex",justifyContent:"space-between"}}>
                                        ...
                                        <Box className='iconBox' sx={{display:"flex",justifyContent:"space-between",width:"14%"}}>
                                            <a style={{marginLeft:"-0.5rem",  textDecoration:"none",color:"white",fontSize:"1.3rem"}} href={ele.github} target={"_blank"} ><i className="fa-brands fa-github"></i></a>
